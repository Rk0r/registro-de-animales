        ...
        <form action="{{ route('animales.update', $animal->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('nombre') is-invalid @enderror" 
                       id="nombre" name="nombre" value="{{ old('nombre', $animal->nombre) }}"
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('especie') is-invalid @enderror" 
                       id="especie" name="especie" value="{{ old('especie', $animal->especie) }}"
                       required maxlength="50" pattern="[A-Za-zÁ-ú\s]+">
                @error('especie')
                    <div class="invalid-feedback">
                        {{ $message }}
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control @error('edad') is-invalid @enderror" 
                       id="edad" name="edad" value="{{ old('edad', $animal->edad) }}"
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('raza') is-invalid @enderror" 
                       id="raza" name="raza" value="{{ old('raza', $animal->raza) }}"
                       required maxlength="50" pattern="[A-Za-zÁ-ú\s]+">
                @error('raza')
                    <div class="invalid-feedback">
                        {{ $message }}
